...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    text = (
        "👋 Вітаю, бро! Я твій AI-помічник.\n\n"
        "Пиши мені будь-що — я відповім як у чаті.\n"
        "Якщо захочеш озвучити текст — тисни кнопку або зміни режим.\n"
        "Команди:\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    text = (
        "ℹ️ Як користуватись:\n"
        "1) Просто пиши мені — я буду відповідати як розумний AI.\n"
        "2) Я використовую веб-пошук для актуальних даних.\n"
        "3) Якщо хочеш озвучити текст — перемкни режим на 'Озвучка'.\n"
        "4) В режимі озвучки я згенерую MP3 з твоїм текстом.\n\n"
        "⚙️ Налаштування:\n"
        "• /voice — вибір голосу для озвучки.\n"
        "• /web — увімкнення/вимкнення веб-пошуку.\n"
        "• /websource — вибір пошуковика (DuckDuckGo/Brave)."
    )
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    mode = str(context.user_data.get("mode", "chat"))
    if mode == "chat":
        try:
